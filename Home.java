 ...
 */
package Advanced.Theory.Mid_Term;

import Advanced.Theory.Mid_Term.Model.SQLHandler;
import Advanced.Theory.Mid_Term.View.Cart;
import Advanced.Theory.Mid_Term.View.Information;
import Advanced.Theory.Mid_Term.View.Login;
...
public class Home extends javax.swing.JFrame {
    ...
    public void showDataProducts() {
        try {
            ...
            while (rs.next()) {
                Object[] rows = {
                    i, rs.getString("name_product"), rs.getString("type_product"), rs.getDouble("price"), rs.getInt("quantity"), rs.getInt("id_product")
                };
    ...
    public void setLabelProduct() {
        try {
            ...
            while (rs.next()) {
                ...
                lab_price1.setText(rs.getString("price"));
    ...
    private void initComponents() {
        ...
        dialog_quantity.setPreferredSize(new java.awt.Dimension(315, 200));

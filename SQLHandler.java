 ...
 */
package Advanced.Theory.Mid_Term.Model;
...
public class SQLHandler {
    ...
    public void updateProduct(int id_product, String name_product, String type_product, String fabric, String madein, Double price, int quantity, String urlimg) {
        String query = "update products set name_product=N'" + name_product + "', type_product= '" + type_product + "', fabric= '" + fabric + "', madein= '" + madein + "', price= " + price + ", quantity= " + quantity + ", urlimg= '" + urlimg + "' where id_product='" + id_product + "'";
        conn.excute(query);
    }
